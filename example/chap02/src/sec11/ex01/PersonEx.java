...
public class PersonEx {
	...
	public static void main(String[] args) {
		// Person 객체 생성
	        ...
	        System.out.println("person1과 person2는 같은 사람 입니까? " + areEqual1);
	        System.out.println("person1과 person3은 같은 사람 입니까? " + areEqual2);
	        ...
	        System.out.println("person1과 person2의 해시 코드 같나요? " + CodesEqual1);
	        System.out.println("person1과 person3의 해시 코드도 같나요? " + CodesEqual2);
	}
